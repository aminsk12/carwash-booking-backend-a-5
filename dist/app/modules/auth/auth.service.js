...
const changePassword = (userId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //   user.password
    // );
    const passwordMatched = yield (0, auth_util_1.isPasswordMatched)(payload.oldPassword, user.password);
...
const forgetPassword = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const resetToken = (0, auth_util_1.createToken)(jwtPayload, config_1.default.jwt_access_secret, '10m');
